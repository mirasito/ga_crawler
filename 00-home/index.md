...
- **[[Текущие приоритеты — v1.1 milestone открыт, Phase 8 parser fix next]]** — что делать прямо сейчас (**v1.1 OPEN 2026-05-13** — 4 phases planned (8-11), 24 reqs mapped 1:1; Phase 8 next via `/gsd-discuss-phase 8` или `/gsd-plan-phase 8`; deploy target **Yandex Cloud kz1** locked; selectolax 0.4 + syrupy 4.7 deps; 30-PDP shape-sampling spike mandatory)
