# Roadmap: GA Crawler — v1.0 (Archived)

> **Archived 2026-05-13.** This is a frozen snapshot of `.planning/ROADMAP.md` at v1.0 milestone close. The live ROADMAP.md was reorganized at this point into milestone-grouped form (collapsed `<details>` block) for v1.1+ growth. Final v1.0 status: **7/7 phases complete**.
