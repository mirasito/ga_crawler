...
| 6. Telegram Delivery + Ops/Business Split | 3/6 | In progress (Wave 0 setup shipped 2026-05-12 Plan 06-01; Wave 1 foundations shipped 2026-05-12 Plan 06-02; Wave 2 service layer shipped 2026-05-12 Plan 06-03: delivery/gate.py D-604 4-check first-fail-wins gate REUSES matcher.strict_key.read_run_status (mirror reporter_run.py D-507) + delivery/telegram_client.py D-601/D-603 aiogram 3.27 wrapper with tenacity wait_chain(5,15,45) explicit sequence (NOT formula-derived — caveat #2) + _RETRY_TYPES = (TelegramNetworkError, TelegramServerError) (4 fail-fast classes excluded per Pitfall A) + TelegramRetryAfter handled OUTSIDE tenacity via asyncio.sleep(retry_after) loop (RESEARCH §11) + B3 FIX precise attempt-tracker via closure-shared dict + before_sleep callback for structlog observability; aiogram-isolation canary confirms 4 sibling delivery modules (config/stats/message_builder/gate/__init__) have ZERO aiogram imports; 29 new GREEN tests across 2 closed Wave-0 stubs (10 gate + 19 telegram_client); 677 → 707 passed, 7 → 5 skipped; 3 Rule-1/3 auto-fixes inline) | - |
