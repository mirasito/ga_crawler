...
| 6. Telegram Delivery + Ops/Business Split | 1/6 | In progress (Wave 0 setup shipped 2026-05-12 Plan 06-01: aiogram 3.28.2 + [tool.ga_crawler.deliver] 6-key namespace D-614 + .env.example D-612 + 3 conftest fixtures + 5-section golden file + 10 skip-marked stubs as red→green targets for Waves 1-4) | - |
